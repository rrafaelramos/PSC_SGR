 ...
 * @author DONO
 */
public class EmailBuscar extends TelaBusca<Email> {
    private TelaEdicao telaMae=null;

    public TelaEdicao getTelaMae() {
        return telaMae;
    }

    public void setTelaMae(TelaEdicao telaMae) {
        this.telaMae = telaMae;
    }
    /**
     * Creates new form SalaBuscar
     */
    public EmailBuscar(Repositorio<Email> repositorio, Class tipo_tela) {
        super(repositorio, tipo_tela);
        initComponents();
    }

    public EmailBuscar(Repositorio<Email> repositorio, Class tipo_tela, HashMap<String, String> filtroPreDeterminado) {
    ...
    @Override
    public void preencheTabela(List<Email> listagem) {
        // Table Model 
        ...
        for(Email s : listagem){
            Vector linha = new Vector();
            linha.add(s.getId());
            linha.add(s.getEmail());
